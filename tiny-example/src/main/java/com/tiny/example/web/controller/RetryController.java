...
public class RetryController {
    ...
    public static class RemoteService {
        ...
        /**
         * 注解Retryable：标记当前方法会使用重试机制 value：重试的触发机制，当遇到Exception异常的时候，会触发重试，这里的Exception你也可以写的更精确
        ...
        /**
         * 注解Recover，标记方法为回调方法，传参与@Retryable的value值需一致 定义回调, 注意异常类型和方法返回值类型要与重试方法一致
         */
        @Recover
