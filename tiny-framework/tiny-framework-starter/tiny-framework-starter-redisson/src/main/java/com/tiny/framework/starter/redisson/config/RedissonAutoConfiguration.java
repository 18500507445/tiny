...
import com.tiny.framework.starter.redisson.enums.RedissonCons;
import com.tiny.framework.starter.redisson.enums.RedissonCons.ConnectionType;
...
public class RedissonAutoConfiguration {
    ...
    public RedissonClient redissonClient() {
        ...
        log.info("初始化RedissonLock {} 方式config，address:{}", connectionType.getDescription(), fullAddress);
